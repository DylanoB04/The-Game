	...
	var action1 = prompt("Choose a team: Ground team | Space team");
		if (action1 == "Ground team") {  //storyline 1
			...
			if (option_a == "stay on course") {
				...
				if (option_b == "evade") {
				...
				else if (option_b == "enter dogfight") {
					...
					else if (option_c == "revert energy") {
